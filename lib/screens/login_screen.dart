...
import 'package:track/screens/reset.dart';
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: field(TextInputType.emailAddress, size, "email", Icons.email, _email),
                  ),
                  Padding(
                    ...
                    child: Container(
                      width: size.width,
                      alignment: Alignment.center,
                      child: field(TextInputType.visiblePassword,size, "password", Icons.lock, _password),
                    ),
                  ),
                  SizedBox(
